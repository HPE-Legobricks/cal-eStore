			...
			<div class="row">
				...
				<div class="span5 paymentsicons">
					<div class="span3 contact">
						<div class="span5 social">
							<ul>
								<li><a href="https://www.facebook.com/CADeptTech/" target="_blank"><i class="icon-facebook"></i></a></li>
								<li><a href="https://twitter.com/cadepttech?lang=en" target="_blank"><i class="icon-twitter"></i></a></li>
