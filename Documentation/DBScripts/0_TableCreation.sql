...
create database calestore default character set utf8;

GRANT ALL PRIVILEGES ON calestore.* TO 'calestore'@'localhost' IDENTIFIED BY 'QW!@qw12';
...
CREATE TABLE CONTRACT (
  CONTRACT_ID   INT(2) NOT NULL AUTO_INCREMENT,
  CONTRACT_NAME VARCHAR(60) NOT NULL,
...
CREATE TABLE PRODUCT_ORDER (
  ...
  CONSTRAINT PRODUCT_ID_FK
    ...
    ON UPDATE NO ACTION)ENGINE=InnoDB DEFAULT CHARSET=utf8;
  	...
  	CREATE TABLE T_REPORT_TYPE1 (
	  KPI_ID INT(4) NOT NULL AUTO_INCREMENT,
	  KPI_NUMBER INT (4) NOT NULL,
	  KPI_DESC VARCHAR(100)  NULL,
	  USER_TYPE VARCHAR(10) NOT NULL,
	  VALUE_FOR_KPI varchar(100) null,
	  CREATED_DATE TIMESTAMP NOT NULL DEFAULT current_timestamp,
	  PRIMARY KEY (KPI_ID)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
	  
	  CREATE TABLE T_REPORT_TYPE2 (
  KPI_ID INT(4) NOT NULL AUTO_INCREMENT,
  KPI_NUMBER INT(4) NOT NULL,
  KPI_DESC VARCHAR(100) NULL,
  ...
  WEEK_ID VARCHAR(30) NULL,
  VENDORNAME VARCHAR(80) NULL,
  CATEGORY_NAME INT(4) NULL,
  VALUE_FOR_KPI INT(10) NULL,
  CREATED_DATE TIMESTAMP NOT NULL DEFAULT current_timestamp,
  PRIMARY KEY (KPI_ID)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
